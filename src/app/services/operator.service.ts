...
export class OperatorService {
  ...
  retryInspection(): Observable<any> {
    return this.http
      .get<{}>(
        baseUrl + 'inspection/retry_inspection/',
        httpOptions
      )
      .pipe(
        map((data) => {
  ...
  sendFlagMessage(payload): Observable<any> {
    return this.http
      .post<{}>(
        baseUrl + 'inspection/flag/',
        payload,
        httpOptions
      )
      .pipe(
  ...
  healthCheck(): Observable<any> {
    return this.http
      .get<{}>(baseUrl + 'inspection/get_health_check/', httpOptions)
      .pipe(
        map((data) => {
          return data;
        }),
